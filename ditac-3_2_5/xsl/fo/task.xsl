...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="*[contains(@class,' task/steps ')]/*[contains(@class,' task/step ')] |
                       *[contains(@class,' task/steps ')]/ditac:flags/*[contains(@class,' task/step ')]">
    <xsl:choose>
  ...
  <xsl:template match="*[contains(@class,' task/steps-unordered ')]/*[contains(@class,' task/step ')] |
                       *[contains(@class,' task/steps-unordered ')]/ditac:flags/*[contains(@class,' task/step ')]">
    <xsl:choose>
      <xsl:when test="u:isCompactSteps(parent::*)">
  ...
  <xsl:template match="*[contains(@class,' task/steptroubleshooting ')]">
    <fo:block xsl:use-attribute-sets="stepresult">
      ...
      <fo:block xsl:use-attribute-sets="steptroubleshooting-title">
        <xsl:call-template name="localize">
  ...
  <xsl:attribute-set name="tasktroubleshooting"
  ...
  <xsl:template match="*[contains(@class,' task/tasktroubleshooting ')]">
    <fo:block xsl:use-attribute-sets="tasktroubleshooting">
      ...
      <fo:block xsl:use-attribute-sets="tasktroubleshooting-title">
        <xsl:call-template name="localize">
          <xsl:with-param name="message" select="'trouble'"/>
        </xsl:call-template>
      </fo:block>
