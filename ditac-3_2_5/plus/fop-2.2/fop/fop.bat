...
set LOGLEVEL=-Dorg.apache.commons.logging.simplelog.defaultlog=ERROR
...
:runFop
rem echo "%JAVACMD%" -Xss4m -Xmx2048m %LOGCHOICE% %LOGLEVEL% -cp "%LOCALCLASSPATH%" org.apache.fop.cli.Main %FOP_CMD_LINE_ARGS%
