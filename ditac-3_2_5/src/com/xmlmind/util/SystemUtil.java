...
public final class SystemUtil {
    ...
    /**
     * Java v1.7.0. See {@link #IS_APPLE_JAVA}.
     */
    ...
    /**
     * Java v1.8.0_40. See {@link #HAS_JAVAFX}.
     */
    public static final VersionNumber JAVA_1_8_0_40 = 
        new VersionNumber(1, 8, 0, VersionNumber.LevelType.PATCH, 40);

    /**
     * Java v9.0.0.
     */
    public static final VersionNumber JAVA_9_0_0 = new VersionNumber(9, 0, 0);
    ...
    /**
     * <code>true</code> if the current Java version is less than 
     * {@link #JAVA_1_8_0}); <code>false</code> otherwise.
     */
    public static final boolean IS_OLD_JAVA =
        (SystemUtil.javaVersionNumber().compareTo(JAVA_1_8_0) < 0);

    /**
     * <code>true</code> if the current Java runtime has a usable, 
     * found by default in the <code>CLASSPATH</code>, JavaFX runtime.
     * <p>This is true as of {@link #JAVA_1_8_0_40}.
     * <p>Windows XP is not considered to have JavaFX because JDK 1.8
     * is not officially supported on it.
     */
    public static final boolean HAS_JAVAFX =
        (SystemUtil.javaVersionNumber().compareTo(JAVA_1_8_0_40) >= 0 &&
