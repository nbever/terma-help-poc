...
/*package*/ final class ConrefIncluder extends Includer {
    ...
    public ConrefIncluder(KeySpaces keySpaces, Console c) {
        super(keySpaces, c);
    }
    ...
    private void checkDomains(Element conrefSource,
        ...
        boolean compatibleDomains =
            DITAUtil.checkDomains(sourceDomains, targetDomains);

        /*
        System.err.println("superset=" + sourceDomains + 
                           ", subset=" + targetDomains + ": " + 
                           compatibleDomains);
        */
