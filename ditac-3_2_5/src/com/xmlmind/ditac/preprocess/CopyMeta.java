...
/*package*/ final class CopyMeta implements Constants {
    ...
    private static void copyMeta(Element topicref,
        ...
        if (lockmeta) {
            ...
            copySearchTitle(topicref, topicmeta, topic);

            if (topicmeta != null) {
                copyElements(topicmeta, topic);
            }
        }
    }
    ...
    private static void copySearchTitle(Element topicref, Element topicmeta,
                                        Element topic) {
        ...
        if (mapSearchtitle != null) {
            ...
            if (topicSearchtitle == null) {
                ...
                replaceChild(titlealts, mapSearchtitle, topicSearchtitle, doc);
            }
        }
    }
    ...
    // (<ux-window> not added to the topic.)
    ...
    private static void copyElements(Element topicmeta, Element topic) {
        Document doc = topic.getOwnerDocument();
