...
public final class DOMUtil {
    ...
    public static String mergeTokens(String value1, String value2) {
        String[] items1 = 
            (value1 == null)? StringList.EMPTY_LIST : XMLText.splitList(value1);
        String[] items2 = 
            (value2 == null)? StringList.EMPTY_LIST : XMLText.splitList(value2);

        for (String item2 : items2) {
            if (!StringList.contains(items1, item2)) {
                items1 = StringList.append(items1, item2);
            }
        }
