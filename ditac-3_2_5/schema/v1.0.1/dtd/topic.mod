...
PUBLIC "-//OASIS//ELEMENTS DITA 1.0 Topic//EN"
...
<!ENTITY % topicDefns   PUBLIC 
                       "-//OASIS//ENTITIES DITA 1.0 Topic Definitions//EN" 
                       "topicDefn.ent"                              >
%topicDefns;
...
<!--                      Table Elements                           -->
<!--    2005.11.15 RDA: Corrected the public ID for tblDecl.mod,   -->
<!--  from the old value "-//OASIS//ELEMENTS DITA 1.0 CALS Tables//EN" -->
...
"-//OASIS//ELEMENTS DITA 1.0 Metadata//EN" 
"metaDecl.mod"                                                       >
%metaXML;

<!--                       Specialization of Declared Elements     -->
<!ENTITY % topicClasses    PUBLIC 
"-//OASIS//ENTITIES DITA 1.0 Topic Class//EN" 
"topicAttr.mod"                                                    >
  %topicClasses;
